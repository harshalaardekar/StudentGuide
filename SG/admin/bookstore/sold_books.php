              ...
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" href="available_books.php?dept=All&sem=All">Available Books</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="requested_books.php?dept=All&sem=All">Requested Books</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="#">Sold Books</a>
                    </li>
                    <li class="nav-item">
