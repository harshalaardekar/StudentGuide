  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="section-title"><h2>2/2 <a href="edit_book1.php">Back</a></h2></div>
...
if(isset($_POST['submit'])){
  ...
  echo "<script type='text/javascript'>window.location='edit_book3.php?ID=$evaluate_id';</script>";
