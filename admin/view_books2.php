...
<div class="main-panel">
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Books </h3>
              <h1>3/3<a href="selectsemdept.php?Page=ViewBooks">Back</a></h1></div>
                      ...
                      <tr> 
                       ...
                       <td>
                         ...
                         <form class="form" action="" method="POST"  >
                          ...
                          <button name="view" type="view" value=<?php echo $object->Book_ID;?> class="btn btn-outline-danger">VIEW</button>
                          </form>
...
if(isset($_POST['view'])){
  ...
  echo "<script type='text/javascript'>window.location='view_books3.php?Book_id=$Book_id&Evaluate_id=$evaluate_id';</script>";
