    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="viewbooks.php?dept=All&sem=All">View Books</a></li>
          ...
          <li><a class="nav-link scrollto active" href="your_books.php">Your Books</a></li>
...
<?php
  ...
  $query_BookStore = mysqli_query($conn,"SELECT * FROM bookstore WHERE BookStore_Seller_ID = '$user_id' AND BookStore_BuyStatus NOT IN ('DELETED')");
...
?>
                  <form class="form" method="post" action="includes/process.php">
                    <button style="width: 100%; margin-bottom: 5px" name="resell" type="resell" value=<?php echo $row_BookStore['BookStore_Book_ID'];?> class="btn btn-outline-danger">Resell</button>
                    <button style="width: 100%; margin-top: 5px" name="sold" type="sold" value=<?php echo $row_BookStore['BookStore_Book_ID'];?> class="btn btn-outline-danger">Sold</button>
                  </form>
<?php
      }
  ...
  <?php
      ...
      else if($row_BookStore['BookStore_BuyStatus']=='OPEN')
      {
