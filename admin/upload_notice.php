        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Upload Notice </h3>
        <form enctype="multipart/form-data" action="" method="POST" >
        <div class="section-title"><h2>2/2 <a href="selectsemdept.php?Page=UploadNotice">Back</a></h2></div>
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="Semester" value="<?php echo $Semester; ?>">
                    ...
                    <div class="form-group">
            <label>Notice Title : </label><input type="name" name="desc" required></div>
          <div class="form-group">
...
$insert = "insert into notice(notice_file,ndesc) values('$newfilename','$desc')";
//echo '<pre>';
if (move_uploaded_file($_FILES['filename']['tmp_name'],$uploaddir . $newfilename)) {
    ...
    if($result){
      ...
      echo "<script type='text/javascript'>window.location='upload_notice.php';</script>";
    }
    else{
      echo "<script> alert('Something went wrong'.$dirfbfd)</script>";
      echo "<script type='text/javascript'>window.location='upload_notice.php';</script>";
    }
} else {
   echo "<script> alert('Something went wrong'.$dirbfxv)</script>";
    echo "<script type='text/javascript'>window.location='upload_notice.php';</script>";
