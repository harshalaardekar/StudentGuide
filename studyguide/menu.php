    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
		...
		<ul id="portfolio-flters" class="d-flex justify-content-center"  data-aos-delay="100">
           ...
           <div style="border-width: thin;border-style: solid;border-color: black;"> <br>

            <marquee><h2 style="color: red;">**** Important Notices****</h2></marquee>
           <table class="center">
      <thead>
        <tr>
                        <!-- <th>Notice ID</th> -->
                      ...
                      <tr> 
                       ...
                       <td>
                        <form class="form" action="" method="POST"  >
                          ...
                          <u style="color: blue;"><a class="ex1" style="border: none; font-size: 14px;" href="view_notice1.php?notice_id=<?php echo $object->nid; ?>" target="_blank"><?php echo $object->ndesc?></a></u>

                          <!-- <button class="button" name="view" style="border: none; font-size: 14px;" value=<?php echo $object->nid;?> class="btn btn-outline-danger"><u style="color: blue;"><?php echo $object->ndesc?></u></button><br> -->
                          </form>
