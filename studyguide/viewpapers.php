  ...
  <main id="main">
    ...
    <ul id="portfolio-flters" class="d-flex justify-content-center"  data-aos-delay="100">
           ...
           <div style="border-width: thin;border-style: solid;border-color: black;width: 85%;"> <br>
            ...
            <h4 style="color: black;margin-left: 20px;">Previous Year Paper Solutions</h4>
...
<?php
      $evaluate_id = $_GET['ID'];
$sql = "select * from paper_solutions where Evaluate_ID='$evaluate_id'";
                      ...
                      <tr> 
                       ...
                       <td>
                        <form class="form" action="" method="POST"  >
                          ...
                          <a class="ex1" href="papers.php?ID=<?php echo $object->paper_id; ?>" target="_blank"><?php echo $object->psfile_name?></a>
...
if(isset($_POST['view'])){
  ...
  echo "<script type='text/javascript'>window.open('papers.php?ID=$paper_id', '_blank');</script>";
}
