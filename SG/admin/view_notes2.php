...
<div class="main-panel">
  ...
  <!-- Table start -->
    ...
    <tbody>
                      ...
                      $query_Notes = mysqli_query($conn, $query);
                      

                      if ($query_Notes) {
                      while ($object = $query_Notes->fetch_object())
                      {
                      ...
                      <tr> 
                       <td><center><?php echo $object->nid?></center></td>
                        <td><?php echo $object->nFileName?></center></td>
                        <td><?php echo $object->description?></td>
                         
                       <td>
                         <form class="form" action="" method="POST"  >
                          <input type="hidden" name="eval" value="<?php echo $Evaluate_ID; ?>">
                          <button name="view" type="view" value=<?php echo $object->nid;?> class="btn btn-outline-danger">VIEW</button>
                          </form>
...
if(isset($_POST['view'])){
  ...
  echo "<script type='text/javascript'>window.location='view_notes3.php?nid=$nid&Evaluate_id=$evaluate_id';</script>";
