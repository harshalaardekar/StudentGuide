  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="section-title"><h2>2/2 <a href="edit-book2.php">Back</a></h2></div>
          ...
          <div class="form-group">
                    ...
                    <div class="">
                      <select id="Subject" name="Subject" class="InputBox">
                        <?php 
                          $evaluate_id = $_GET['ID'];
                          $query = "SELECT ISBN FROM evaluate WHERE Evaluate_ID=$evaluate_id";
...
if(isset($_POST['submit'])){
  ...
  $data=mysqli_query($conn, $query);
    ...
    {
     echo "<script> alert('Something Went Wrong... $evaluate_id $Book_Name $Author_Name $Book_Price $Initial_Rating $Book_Publication $Book_Image $Book_Link $ISBN $Book_GNRE $Book_Edition $Book_Type ')</script>";
    }
