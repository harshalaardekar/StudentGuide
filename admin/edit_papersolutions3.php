      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            <h3 class="page-title"> Update Paper Solutions Details</h3>
            
            <form enctype="multipart/form-data" action="" method="POST" style="padding-left: 65%;">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="hidden" name="oldfilename" value="<?php echo $row['psfile_name']?>">
...
echo "<script type='text/javascript'>window.location='edit_papersolutions2.php?Evaluate_ID=$Evaluate_id';</script>";
}
...
if($result){
echo "<script> alert('Paper Solutions Updated Successfully')</script>";
echo "<script type='text/javascript'>window.location='edit_papersolutions2.php?Evaluate_ID=$evaluate_id';</script>";
}
else{
