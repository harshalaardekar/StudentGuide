        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Notes</h3>
              ...
              while($info=mysqli_fetch_array($data))
               {
                  ...
                  ?>
                  <embed type="application/pdf" src="uploads/notes/<?php echo $eval."/".$info['nFileName']; ?>" style="width:100%;height:600px;">
...
echo "<script type='text/javascript'>window.location='view_notes2.php?Evaluate_ID=$Evaluate_id';</script>";
}
