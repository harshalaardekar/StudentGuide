...
<div class="main-panel">
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Notes Data</h3>
  ...
  <!-- Table start -->
    ...
    <tbody>
                      ...
                      $query = "SELECT * FROM notes WHERE Evaluate_ID= '$Evaluate_ID'";
                      ...
                      <tr> 
                        ...
                        <td><?php echo $object->nFileName ?></td>
                       ...
                       <td>
                        <form class="form" action="" method="POST"  >
                          ...
                          <div class ="row">
                            <div class = "col-sm-5">
                              <button name="edit" type="edit" value=<?php echo $object->nid;?> class="btn btn-outline-danger">Edit</button>
                            </div>
                            <div class = "col-sm-5">
                              <button name="delete" type="delete" value=<?php echo $object->nid;?> class="btn btn-outline-danger">Delete</button>
                            </div>
                          </div>
...
if(isset($_POST['edit'])){
  ...
  echo "<script type='text/javascript'>window.location='edit_notes3.php?Notes_id=$Notes_id&Evaluate_id=$evaluate_id';</script>";

}
if(isset($_POST['delete'])){
  $Notes_id = $_POST['delete'];
  $evaluate_id = $_POST['eval'];
   // echo "<script type='text/javascript'>alert('.$evaluate_id.');  </script>";
  echo "<script type='text/javascript'>window.location='delete_notes.php?Notes_id=$Notes_id&Evaluate_id=$evaluate_id';</script>";
}
?>