  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="section-title"><h2>2/2 <a href="selectsemdept.php?Page=UploadPaperSolutions">Back</a></h2></div>
...
$insert = "insert into paper_solutions(psfile_name,evaluate_ID,description) values('$newfilename','$evaluate_id','$desc')";
//echo '<pre>';
