...
if($result->num_rows > 0){
  $query="DELETE FROM notes WHERE nid = '$Notes_id'";
  $data=mysqli_query($conn, $query);
    ...
    {
     echo "<script> alert('Something".$oldfilename." Went Wrong...')</script>";
     
    }
}
else {
   echo "<script> alert('Enter Correct Password...')</script>";
   echo "<script type='text/javascript'>window.location='delete_books.php?Notes_id=$Notes_id'&Evaluate_ID=$Evaluate_id';</script>";
}
