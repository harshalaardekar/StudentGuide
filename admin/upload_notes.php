  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="section-title"><h2>2/2 <a href="selectsemdept.php?Page=UploadNotes">Back</a></h2></div>
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="Semester" value="<?php echo $Semester; ?>">
                    ...
                    <div class="form-group">
            <label>Description : </label><input type="name" name="desc" required></div>
          <div class="form-group">
...
$insert = "insert into notes(nFileName,evaluate_ID,description) values('$newfilename','$evaluate_id','$desc')";
//echo '<pre>';
if (move_uploaded_file($_FILES['filename']['tmp_name'],$uploaddir . $newfilename)) {
    ...
    if($result){
      ...
      echo "<script type='text/javascript'>window.location='selectsemdept.php?Page=UploadNotes';</script>";
    }
    else{
