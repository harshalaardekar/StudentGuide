...
$update1 = "update syllabus_copy set sfile_name = '$newfilename',description = '$desc' where syllabus_id='$Syllabus_id'";

$result = mysqli_query($conn,$update1);

// echo $oldfilename .$desc.$Syllabus_ids.$filename;

echo "<script> alert('".$oldfilename .$desc.$Syllabus_ids.$filename.$newfilename."')</script>";
...
// echo "<script> alert('Something went wrong!!! fbdfbd')</script>";
// }
// }
// else {
// echo "Possible file upload attack!\n";
// echo "<script> alert('Something went wrong!!!354')</script>";
// }
