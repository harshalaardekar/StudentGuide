...
<?php
  ...
  $query_NoteStore = mysqli_query($conn,"SELECT * FROM notesstore WHERE Notes_Seller_ID = '$user_id'");
...
?> 
              <tr>
                ...
                <td><?php echo $row_NoteStore['Notes_Name']?></td>
                <td><?php echo $row_NoteStore['Notes_Price']?></td>
                <td>
                <form class="form" method="post" action="includes/process.php">
                  <button style="width: 100%;" name="delete" type="delete" value=<?php echo $row_NoteStore['Notes_ID'];?> class="btn btn-outline-danger">Delete</button>
                </form>
                </td>
                <td><center>
                  <form class="form" method="post" action="view_details.php">
                    <button style="width: 150px; margin-bottom: 5px" name="view_details" type="view_details" value=<?php echo $row_NoteStore['Notes_ID'];?> class="btn btn-outline-warning">Show Details</button>
                  </form></center>
                </td>
              </tr>
<?php
