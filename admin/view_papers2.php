                      ...
                      <tr> 
                       ...
                       <td>
                        <form class="form" action="" method="POST"  >
                          ...
                          <button name="view" type="view" value=<?php echo $object->paper_id;?> class="btn btn-outline-danger">VIEW</button>
                          </form>
...
if(isset($_POST['view'])){
  ...
  echo "<script type='text/javascript'>window.location='view_papers3.php?paper_id=$paper_id&Evaluate_id=$evaluate_id';</script>";
