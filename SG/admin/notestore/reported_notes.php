              ...
              <div class="col-md-12">
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link" href="view_notes.php?dept=All&sem=All">View Notes</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="#">Reported Notes</a>
                    </li>
                  </ul>
                </div>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <?php echo'<img src="includes/pdf.png" alt="image for book" width="240px" height="250px" Style="padding: 10px">'?>
