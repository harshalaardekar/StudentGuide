  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="section-title"><h2>2/2 <a href="selectsemdept.php?Page=Syllabus">Back</a></h2></div>
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="Semester" value="<?php echo $Semester; ?>">
                  ...
                  <div class="form-group">
            <label>Description : </label><input type="name" name="desc" ></div>
          <div class="form-group">
...
$insert = "insert into syllabus_copy(sfile_name,evaluate_ID,description) values('$newfilename','$evaluate_id','$desc')";
